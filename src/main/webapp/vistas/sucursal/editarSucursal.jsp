...
<html>
<head>
    <title>Editar Sucursal - CodeNBuses</title>
</head>
<body>
    ...
    <form method="POST" action="<%= request.getContextPath() %>/sucursal">
        ...
        <label>Nombre:</label>
        <br>
        <input type="text" name="nombre" value="<%= sucursal.getNombre() %>" required/>
        <br>

        <label>Ubicación:</label>
        <br>
        <input type="text" name="ubicacion" value="<%= sucursal.getUbicacion() %>" required/>
        <br>
